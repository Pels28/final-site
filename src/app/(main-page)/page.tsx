  ...
  return (
    <div className="w-screen overflow-hidden">
      <>
        ...
        <div className="bg-gray w-full h-[800px]  p-8 flex flex-col md:flex-row items-start md:items-center justify-start gap-8">
          <Card
            shadow
            rounded
            padded={false}
          ...
          >
            ...
            >
              <NextButton
                ...
                color="primary"
                size="lg"
                className="px-8 mt-5 rounded-full mb-4"
              >
                Read more
              </NextButton>
            </motion.div>
